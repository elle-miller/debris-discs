...
ax.plot(d2g_mid, mask, ls='--', color="black", linewidth=1, label='step')
ax.plot(d2g_mid, switch1, color="C0", ls='-.', label='n = 0.01')
ax.plot(d2g_mid, switch, color="C3", label='n = 0.03')
